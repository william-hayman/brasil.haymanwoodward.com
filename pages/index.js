            ...
            <div className={"col-md-5"}>
              <div className={"row"}>
                ...
                <div className={"col-md-12 mt-4 " + styles.title}>
                  <h1>
                    {t("exclusiveIn")}{" "}
                    <Image src={Flag} alt="Event Country Flag" quality="100" />
                  </h1>
                  <h3>{t("select")}:</h3>
                </div>
                <div className={"col-md-12 my-2 " + styles.link}>
                  <Link href={`/` + locale + `/webinar`}>
                    {t("webinar")} | {t("may30")}
                  </Link>
                </div>
                <div className={"col-md-12 my-2 " + styles.link}>
                  <Link href={`/` + locale + `/rio-verde/evento`}>
                    {t("localeRV")} | {t("dateRV")} | {t("live")}
                  </Link>
                </div>
                <div className={"col-md-12 my-2 " + styles.link}>
                  <Link href={`/` + locale + `/brasilia/evento`}>
                    {t("localeBRASILIA")} | {t("dateBRASILIA")} | {t("live")}
                  </Link>
                </div>
                <div className={"col-md-12 my-2 " + styles.link}>
                  <Link href={`/` + locale + `/goiania/evento`}>
                    {t("localeGOI")} | {t("dateGOI")} | {t("live")}
                  </Link>
                </div>
                <div className={"col-md-12 my-2 " + styles.link}>
                  <Link href={`/` + locale + `/belo-horizonte/evento`}>
                    {t("localeBH")} | {t("dateBH")} | {t("live")}
                  </Link>
                </div>
                <div className={"col-md-12 my-2 " + styles.link}>
                  <Link href={`/` + locale + `/governador-valadares/evento`}>
                    {t("localeGV")} | {t("dateGV")} | {t("live")}
                  </Link>
                </div>
                <div className={"col-md-12 my-2 " + styles.link}>
                  <Link href={`/` + locale + `/sao-paulo/evento`}>
                    {t("localeSP")} | {t("dateSP")} | {t("live")}
                  </Link>
                </div>
                <div className={"col-md-12 my-2 " + styles.link}>
                  <Link href={`/` + locale + `/curitiba/evento`}>
                    {t("localePR")} | {t("datePR")} | {t("live")}
                  </Link>
                </div>
                <div className={"col-md-12 my-2 " + styles.link}>
                  <Link href={`/` + locale + `/porto-alegre/evento`}>
                    {t("localeRS")} | {t("dateRS")} | {t("live")}
                  </Link>
                </div>
                <div className={"col-md-12 my-2 " + styles.link}>
                  <Link href={`/` + locale + `/rio-de-janeiro/evento`}>
                    {t("localeRJ")} | {t("dateRJ")} | {t("live")}
                  </Link>
                </div>
                ...
                <div className={"col-md-12 mt-5"}>
                  <div className="row">
                    ...
                    <Col
                      sm={12}
                      className={styles.haybrand + " text-center py-5"}
                    >
                      © 2023 Hayman-Woodward {t("developed")}{" "}
                      <span>Hay Branding</span>.
                    </Col>
                  </div>
                </div>
              </div>
...
Home.getLayout = function getLayout(page) {
  return <LayoutSelect>{page}</LayoutSelect>;
};

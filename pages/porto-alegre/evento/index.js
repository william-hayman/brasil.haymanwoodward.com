...
export default function Home() {
  ...
  return (
    <>
      ...
      <Cta  url={url} localeId={t('localeRS')} eventDate={t('dateRS')} eventType={t('live')} eventHour={eventHour}/>
      <Countdown deadline="2023-07-22 08:00" url={url}/>
      <About url={url}/>
      <Cases url={url}/>
      <Sponsors />
      <Questions />
...
Home.getLayout = function getLayout(page) {
  const { props } = page
  return (
      <Layout url="porto-alegre/evento">{page}</Layout>
  )
}
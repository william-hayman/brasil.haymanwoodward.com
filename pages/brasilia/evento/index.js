...
export default function Home() {
  ...
  return (
    <>
      ...
      <Cta  url={url} localeId={t('localeBRASILIA')} eventDate={t('dateBRASILIA')} eventType={t('live')} eventHour={eventHour}/>
...
Home.getLayout = function getLayout(page) {
  const { props } = page
  return (
      <Layout url="brasilia/evento">{page}</Layout>
  )
}
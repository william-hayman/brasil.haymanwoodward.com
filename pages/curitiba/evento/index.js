...
export default function Home() {
  ...
  return (
    <>
      ...
      <Cta  url={url} localeId={t('localePR')} eventDate={t('datePR')} eventType={t('live')} eventHour={eventHour}/>
      <Countdown deadline="2023-07-19 08:00" url={url}/>
      <About url={url}/>
      <Cases url={url}/>
      <Sponsors />
      <Questions />
...
Home.getLayout = function getLayout(page) {
  const { props } = page
  return (
      <Layout url="curitiba/evento">{page}</Layout>
  )
}
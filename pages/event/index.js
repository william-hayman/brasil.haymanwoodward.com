...
export default function Home() {
  ...
  return (
    <>
      ...
      <Cta  url={url} localeId={t('locale')} eventDate={t('1920may')} eventType={t('live')} eventHour={eventHour}/>
      <Countdown deadline="2023-05-19 08:00" url={url}/>
      <About url={url}/>
      <Cases url={url}/>
      <Sponsors />
      <Questions />
